...
import image1 from '../assets/W.Images/1.jpg'
import image2 from '../assets/W.Images/2.jpg'
import image3 from '../assets/W.Images/3.jpg'
import image4 from '../assets/W.Images/4.jpg'
import image5 from '../assets/W.Images/5.jpg'
import image6 from '../assets/saleImages/13.jpg'
import image7 from '../assets/saleImages/14.jpg'
import image8 from '../assets/saleImages/15.jpg'
import image9 from '../assets/saleImages/13.jpg'
import image10 from '../assets/W.Images/4.jpg'

const scarfsData = [
  { id: 1, name: "Elegant  Watch", price: "$20", discount: "10% Off", image: image1 },
  { id: 2, name: "Floral Watch", price: "$15", discount: "15% Off", image: image2 },
  { id: 3, name: "Men's Watch", price: "$25", discount: "20% Off", image:image3  },
  { id: 4, name: "Casual Watch", price: "$18", discount: "12% Off", image: image4 },
  { id: 5, name: "Luxury Watch", price: "$35", discount: "8% Off", image:image5  },
  { id: 6, name: "Boho Style Watch", price: "$22", discount: "10% Off", image:image6  },
  { id: 7, name: "Classic Watch", price: "$19", discount: "15% Off", image:image7  },
  { id: 8, name: "Men's Watch", price: "$12", discount: "5% Off", image:image8  },
  { id: 9, name: " Fashion Watch", price: "$16", discount: "10% Off", image:image9  },
  { id: 10, name: "Luxury Watch", price: "$30", discount: "18% Off", image:image10  },
  { id: 11, name: "Elegant Watch", price: "$20", discount: "10% Off", image: image1 },
  { id: 12, name: "Floral Watch", price: "$15", discount: "15% Off", image: image2 },
];
