  ...
  return (
    <div className="relative bg-white shadow-md rounded-lg overflow-hidden group flex flex-col justify-between">
      ...
      <button
        ...
        className="w-[90%] rounded-lg absolute bottom-4 left-1/2 transform -translate-x-1/2 
        bg-gray-200 text-black px-4 py-2 rounded opacity-0 transition-opacity duration-300
         group-hover:opacity-100 
        hover:bg-black hover:text-white group-hover:backdrop-blur-lg flex items-center"
      >
      ...
      {/* 📜 Product Details */}
      <div className="p-4 text-center min-h-[120px]">
